...
namespace TestHarnessMessages
{
    ...
    public class TestElement:MarshalByRefObject  /* information about a single test */
    {
    ...
    public class LogRequest:MarshalByRefObject {
        public string author { get; set; }
        public string TestRequestName { get; set; }
    }


    public class TestRequest: MarshalByRefObject  /* a container for one or more TestElements */
    {
        public string author { get; set; }
        public string TestRequestName { get; set; }
    ...
    public class TestResult: MarshalByRefObject  /* information about processing of a single test */
    {
        public string testName { get; set; }
    ...
    public class TestResults: MarshalByRefObject /* a container for one or more TestResult instances */
    {
        public string author { get; set; }
