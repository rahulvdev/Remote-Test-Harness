...
namespace UserInterface_2
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void hostClient()
        {
            ...
            string rcvrEndPoint = Comm<ClientTH_2>.makeEndPoint("http://localhost", clientPort);
            try
            {
        ...
        private void SubmitTestRequestButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                msg.from = Comm<ClientTH_2>.makeEndPoint("http://localhost", clientPort);
                msg.to = Comm<ClientTH_2>.makeEndPoint("http://localhost", testHarPort);
        ...
        private void queryLogButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            logMsg.to = Comm<ClientTH_2>.makeEndPoint("http://localhost", repPort);
            logMsg.from = Comm<ClientTH_2>.makeEndPoint("http://localhost", clientPort);
        ...
        {
            string senderEndPoint1 = Comm<ClientTH_2>.makeEndPoint("http://localhost", repPort);
        ...
        {
            string reqPath = "..\\..\\..\\TestRequest//tRequest.xml";
            Messages.Message msg = new Messages.Message();
            try
            {
                XDocument tReQDoc = new XDocument();
